const secretPhrases = ["never", "you", "that", "light", "break"];
...
function checkIfWon() {
    if (randomItem === result) {
        ...
        document.getElementById("gameover").querySelector("p").innerHTML=`<h1 class='winner'>Congratulations!</h1>`;
...
function checkIflost() {
    if (mistakes === 6) {
        document.getElementById("gameover").querySelector("p").style.display = "block";
        document.getElementById("gameover").querySelector("p").innerHTML="<h1>Game over</h1>";
